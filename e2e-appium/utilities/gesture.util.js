...
class GestureUtil {
  ...
  /**
   * Perform directional swipe using W3C actions
   */
  ...
  /**
   * Scroll down until element with selector is visible
   */
  ...
  /**
   * Drag and Drop element from source to target location/element
   */
  ...
  /**
   * Pinch (zoom out) gesture on screen
   */
  ...
  /**
   * Zoom (pinch in reverse) gesture on screen
   */
