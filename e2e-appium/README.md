...
- **Pattern**: Page Object Model (POM) with component delegation & Smart AI screen discovery
...
1. **Node.js**: Install Node.js v18 or v20+.
2. **Java JDK**: Install Java JDK 11 or 17 (`JAVA_HOME` environment variable configured).
...
Navigate to the test framework directory and install dependencies:
...
2. Configures Node.js 20 & Java 17.
3. Launches Android Emulator (API 33, Google APIs).
4. Installs Appium 2.x and UiAutomator2 driver.
5. Executes E2E test suites.
6. Generates Mochawesome and 4-sheet Excel reports.
7. Uploads test artifacts (`Mobile_E2E_Report.xlsx`, HTML reports, screenshots, logcat logs).
